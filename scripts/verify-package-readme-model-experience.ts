...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-browser-notifications': { kind: 'none', reason: 'Browser-side notification and settings UI; registers nothing model-facing.' },
  ...
  'packages/client/locale-ko': { kind: 'none', reason: 'Browser-side language pack; registers nothing model-facing.' },
  ...
  'packages/lsp/lsp-auto': { kind: 'indirect', reason: 'The detection front delegates model rendering to dsh-tool-lsp.' },
