...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // `cordis/*` is the harness-owned dynamic-extension event namespace, while
  // bare `cordis` is its UI locale and slash-trigger id. They are runtime
  // identifiers rather than imports from the rescoped framework package.
