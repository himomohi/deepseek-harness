...
来源：[`packages/llm/llm-deepseek/src/index.ts:80`](../packages/llm/llm-deepseek/src/index.ts)
...
- `@deepseek-ai/dsh-client-locale-ko`（[`packages/client/locale-ko/src/index.ts`](../packages/client/locale-ko/src/index.ts)）
