...
export const en = {
  ...
  syncModels: 'Sync from OpenCodex',
  syncing: 'Syncing from OpenCodex…',
  ...
  visionFallbackIntro: 'Automatically route image inputs to a vision model when using text-only models (e.g. DeepSeek-V3/R1).',
  visionFallbackEnabled: 'Enable Vision Fallback',
  visionFallbackMode: 'Fallback Strategy',
  visionFallbackModeAuto: 'Automatic (Recommended - detect best vision model)',
  visionFallbackModeCustom: 'Custom Provider & Model',
  visionFallbackProvider: 'Fallback Provider',
  visionFallbackModel: 'Fallback Model',
  visionFallbackMaxTokens: 'Max Vision Output Tokens',
  visionFallbackSaved: 'Vision Fallback settings saved.',
  visionFallbackSave: 'Save Vision Settings',
  visionFallbackSaving: 'Saving…',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchAdopt: '添加所选',
  syncModels: '从 OpenCodex 同步',
  syncing: '正在从 OpenCodex 同步…',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
  ...
  visionFallbackTitle: '视觉模型自动回退 (Vision Fallback)',
  visionFallbackIntro: '使用纯文本模型（如 DeepSeek-V3/R1）时遇到图片输入，自动调用多模态视觉模型进行 OCR 与画面解析。',
  visionFallbackEnabled: '启用视觉回退',
  visionFallbackMode: '回退策略',
  visionFallbackModeAuto: '自动探测（推荐 - 自动寻找最优视觉模型）',
  visionFallbackModeCustom: '自定义提供方与模型',
  visionFallbackProvider: '回退提供方',
  visionFallbackModel: '回退模型',
  visionFallbackMaxTokens: '视觉解析最大 Token 数',
  visionFallbackSaved: '视觉回退设置已保存。',
  visionFallbackSave: '保存视觉设置',
  visionFallbackSaving: '保存中…',
}
